...
public class MemberController {
  ...
  public String add(HttpServletRequest request, Member member, Part file) throws Exception {
  ...
  public String detail(Map<String,Object> model, int no) throws Exception {
  ...
  public String update(HttpServletRequest request, Member member, Part file) throws Exception {
