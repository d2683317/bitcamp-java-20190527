...
public class DispatcherServlet extends HttpServlet {
  ...
  private Method findRequestHandler(Object obj) {
    //import static org.reflections.ReflectionUtils.*; 클래스 생략할 수 있다.
    // Set<Method> methods = ReflectionUtils.getMethods(obj.getClass(), 
    //ReflectionUtils.withAnnotation(RequestMapping.class), ReflectionUtils.withModifier(Modifier.PUBLIC));
    Set<Method> methods = getMethods(obj.getClass(), withAnnotation(RequestMapping.class), withModifier(Modifier.PUBLIC));
