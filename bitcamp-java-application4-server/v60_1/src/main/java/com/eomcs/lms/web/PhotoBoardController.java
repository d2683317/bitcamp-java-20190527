...
public class PhotoBoardController {
  ...
  @PostMapping("add")
  public String add(PhotoBoard photoBoard, MultipartFile[] filePath) throws Exception {
  ...
  @PostMapping("update")
  public String update(PhotoBoard photoBoard, MultipartFile[] filePath) throws Exception {
    // 사진 파일 정보를 사진 게시물에 담는다.
    photoBoard.setFiles(photoFileWriter.getPhotoFiles(filePath));
