...
public class LessonCommand {
  ...
  public void detail(ServletRequest request, ServletResponse response) {
    ...
    try {
      ...
      if (lesson == null) {
        ...
        out.printf("수업명 : <input type='text' name='contest' value='%s'><br>\n", lesson.getTitle());
        out.printf("설명 : <textarea name='contents' rows='5'"
  ...
  public void list(ServletRequest request, ServletResponse response) {
    ...
    try {
      ...
      out.println("<tr><th>번호</th><th>수업명</th><th>기간</th><th>총수업시간</th></tr>");
