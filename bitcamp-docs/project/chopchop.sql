...
CREATE TABLE member (
  ...
  grade          INTEGER      NOT NULL COMMENT '등급' -- 등급
)
COMMENT '회원';
...
CREATE TABLE pet (
  ...
  created_date CHAR(10)     NOT NULL COMMENT '등록일', -- 등록일
...
CREATE TABLE recipe (
  ...
  member_id    INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
  title        VARCHAR(50)   NOT NULL COMMENT '이름', -- 이름
  created_date datetime     default now() COMMENT '작성일', -- 작성일
  view_count   INTEGER      default 0 COMMENT '조회수', -- 조회수
...
CREATE TABLE recipe_comment (
  ...
  created_date CHAR(10) NOT NULL COMMENT '작성일' -- 작성일
)
COMMENT '레시피댓글';
...
CREATE TABLE event (
  ...
  start_date   CHAR(10)    NOT NULL COMMENT '시작일', -- 시작일
  end_date     CHAR(10)    NULL     COMMENT '종료일', -- 종료일
  created_date CHAR(10)    NOT NULL COMMENT '작성일' -- 작성일
)
COMMENT '이벤트';
...
CREATE TABLE recipe_ranking (
  ...
  date             CHAR(6) NOT NULL COMMENT '년월', -- 년월
...
CREATE TABLE store_order (
  ...
  payment_date   CHAR(10)     NOT NULL COMMENT '주문일', -- 주문일
...
CREATE TABLE category (
  ...
  title       VARCHAR(255) NOT NULL COMMENT '분류명' -- 분류명
)
COMMENT '동물분류';
...
CREATE TABLE breed (
  breed_id    INTEGER      NOT NULL COMMENT '동물품종번호', -- 동물품종번호
  title       VARCHAR(255) NOT NULL COMMENT '품종명', -- 품종명
  category_id INTEGER      NOT NULL COMMENT '동물분류번호' -- 동물분류번호
)
COMMENT '동물품종';
...
CREATE TABLE cooking (
  ...
  recipe_id  INTEGER     NOT NULL COMMENT '레시피 번호', -- 레시피 번호
  process_no INTEGER     NOT NULL COMMENT '조리순서', -- 조리순서
  photo      VARCHAR(50) NOT NULL COMMENT '사진', -- 사진
  content    TEXT        NOT NULL COMMENT '내용' -- 내용
)
COMMENT '조리과정';
