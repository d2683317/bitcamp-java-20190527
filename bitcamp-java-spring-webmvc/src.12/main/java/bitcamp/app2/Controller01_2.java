// 기본 View Resolver 교체하기 - InternalResourceViewResolver 사용하기
...
public class Controller01_2 {
  ...
  // 테스트:
  //   http://localhost:8888/bitcamp-java-spring-webmvc/app2/c01_2/h1
  @GetMapping("h1") 
  public String handler1(Map<String,Object> map) {
    ...
    // ViewResolver?
    // => 페이지 컨트롤러가 리턴한 뷰 이름의 해당하는 뷰 콤포넌트를 찾아 실행하는 역할.
  ...
  // 테스트:
  //   http://localhost:8888/bitcam-java-spring-webmvc/app2/c01_2/h2
  @GetMapping("h2") 
  ...
  // 테스트:
  //   http://localhost:8888/bitcam-java-spring-webmvc/app2/c01_2/h3
  @GetMapping("h3") 
  ...
  // 테스트:
  //   http://localhost:8888/bitcam-java-spring-webmvc/app2/c01_2/h4
  @GetMapping("h4") 
  ...
  // 테스트:
  //   http://localhost:8888/bitcam-java-spring-webmvc/app2/c01_2/h5
  @GetMapping("h5") 
