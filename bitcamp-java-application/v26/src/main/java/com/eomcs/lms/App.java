...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    commandMap.put("/leeson/add", new LessonAddCommand(input, lessonList));
    commandMap.put("/leeson/delete", new LessonDeleteCommand(input, lessonList));
    commandMap.put("/leeson/detail", new LessonDetailCommand(input, lessonList));
    commandMap.put("/leeson/list", new LessonListCommand(lessonList));
    commandMap.put("/leeson/update", new LessonUpdateCommand(input, lessonList));
